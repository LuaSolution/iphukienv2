...
?>
                            <div class="" style="position: relative">
                                <!-- con này dùng thư viện slick. nên đoạn này không dùng carousel-item được. -->
...
?>
                    ...
                    <div class="ipk-next-slide" style="right: 50px !important;z-index: 100"></div>
                </div>
            @endif
...
// When the user clicks anywhere outside of the modal, close it
        ...
        $(document).on("click", ".ipk-next-slide", function () {
          $('.sale-product-slider').slick('next');
        });
        $(document).on("click", ".ipk-pre-slide", function () {
          $('.sale-product-slider').slick('prev');
        });
